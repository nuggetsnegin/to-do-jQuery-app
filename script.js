// INSERT CODE HERE
    $(document).ready(function(){ /*check if jquery is reji*/
        console.log('ready');

        $('form').on('submit', function(e){ /*submit is the event, form is where the event happens*/
    ...
    /*The .val() method is primarily used to get the values of form elements such as input, select and textarea. When called on an empty collection, it returns undefined.*/
            ...
            if(toDoItem !== ''){ /*if to do isnt empty*/
